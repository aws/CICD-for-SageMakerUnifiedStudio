...
פרוס DAG של Airflow, מחברות Jupyter וזרימות עבודה ML מפיתוח לייצור בביטחון. נבנה עבור מדעני נתונים, מהנדסי נתונים, מהנדסי ML ומפתחי אפליקציות GenAI העובדים עם צוותי DevOps.
...
**צפייה בפעולה:** [דוגמה חיה ב-GitHub Actions](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/actions/runs/24535194879)
...
- צוותי נתונים אף פעם לא נוגעים בהגדרות CI/CD
...
- **Multi-Domain ו-Multi-Region:** פרויקטי stage יכולים להשתייך לדומיינים שונים של SMUS, חשבונות AWS ואזורים. לדוגמה, ה-dev stage שלך עשוי להיפרס לדומיין פיתוח ב-us-east-1, בעוד prod נפרס לדומיין ייצור ב-eu-west-1.
...
- **[מדריך Connections](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/docs/connections.md)** - הגדרת אינטגרציות לשירותי AWS
...
- **[מדריך אפליקציית GitHub Workflow](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/docs/github-workflow-application-guide.md)** - מדריך מנהל אפליקציה לפריסה ישירה מענף
...
### עיון
- **[Manifest Schema](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/docs/manifest-schema.md)** - אימות ומבנה סכמת YAML
...
- **[הקשר עוזר AI](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/developer/AmazonQ.md)** - הקשר לעוזרי AI (Amazon Q, Kiro)
