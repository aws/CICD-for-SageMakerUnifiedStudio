...
> **[דומיינים של IAM + IdC]** CLI זה תומך בדומיינים מבוססי IAM ומבוססי IAM Identity Center (IdC) של SMUS. עבור דומיינים של IdC, ייתכן שיידרש הגדרה נוספת (רשת VPC, הרשאות Lake Formation, מדיניות IAM מוטמעות) — ראה את סקריפטי ההגדרה בכל תיקיית דוגמה.
...
- **[יצירת Manifest באמצעות AI](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/docs/generate-manifest-skill.md)** - כישור סוכן שסורק את הפרויקט שלך ויוצר manifest
...
- **[מדריך אפליקציה ל-GitHub Workflow](https://github.com/aws/CICD-for-SageMakerUnifiedStudio/blob/main/docs/github-workflow-application-guide.md)** - מדריך למנהל אפליקציה לפריסה ישירה מענף
